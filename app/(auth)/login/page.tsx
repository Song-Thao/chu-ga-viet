    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-black text-2xl text-gray-800">Chủ Gà Việt</h1>
          <p className="text-gray-500 text-sm mt-1">Đăng nhập để mua bán và phân tích gà</p>
        </div>

        {/* GOOGLE LOGIN */}
        <button onClick={handleGoogle}
          className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl py-3 font-semibold text-gray-700 hover:bg-gray-50 transition mb-4">
